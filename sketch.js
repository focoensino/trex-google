var trex,trexCorrendo,chao,imagemChao,subchao,nuvem,imagemNuvem,cacto,escolherCacto,tempoJogo,imagemFim,imagemReiniciar,somPulo,somMorrendo,somChekpoint;
...
trexCorrendo = loadAnimation("trex1.png","trex2.png","trex3.png")
  ...
  imagemNumem = loadImage("cloud.png")
  ...
  somChekpoint=loadSound("checkPoint.mp3")
}
function setup() {
